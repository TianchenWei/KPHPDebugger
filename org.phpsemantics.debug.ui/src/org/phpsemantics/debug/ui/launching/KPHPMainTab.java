...
import org.phpsemantics.debug.ui.IKPHPLaunchConfigurationConstants;
...
public class KPHPMainTab extends AbstractLaunchConfigurationTab {
	...
	public void setDefaults(ILaunchConfigurationWorkingCopy configuration) {
		...
		//IPath path = null;
		configuration.setAttribute(IKPHPLaunchConfigurationConstants.ATTR_FILE_TO_DEBUG, "");	
		configuration.setAttribute(IKPHPLaunchConfigurationConstants.ATTR_KTOOL_BIN, "");
		configuration.setAttribute(IKPHPLaunchConfigurationConstants.ATTR_KPHP_ROOT, "");
		
		//TODO()
		configuration.setAttribute(IKPHPLaunchConfigurationConstants.ATTR_TEMP_DIR, IKPHPLaunchConfigurationConstants.DEFAULT_TEMP_DIR);
	}
		...
		try {
			fKPHPText.setText(
					configuration.getAttribute(
							IKPHPLaunchConfigurationConstants.ATTR_KPHP_ROOT,"")); //$NON-NLS-1$
			fKToolText.setText(
					configuration.getAttribute(
							IKPHPLaunchConfigurationConstants.ATTR_KTOOL_BIN, "")); //$NON-NLS-1$
			fPHPFileText.setText(
					configuration.getAttribute(
							IKPHPLaunchConfigurationConstants.ATTR_FILE_TO_DEBUG, "")); //$NON-NLS-1$
	...
	public void performApply(ILaunchConfigurationWorkingCopy configuration) {
		configuration.setAttribute(
				IKPHPLaunchConfigurationConstants.ATTR_KPHP_ROOT, fKPHPText.getText());
		configuration.setAttribute(
				IKPHPLaunchConfigurationConstants.ATTR_KTOOL_BIN, fKToolText.getText());
		configuration.setAttribute(
				IKPHPLaunchConfigurationConstants.ATTR_FILE_TO_DEBUG, fPHPFileText.getText());
	}
